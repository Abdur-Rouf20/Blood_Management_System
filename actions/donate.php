<!-- donate.php placeholder -->
 <?php
session_start();

if (!isset($_SESSION['donor_id'])) {
    header('Location: ../blood_Donor_management_system/auth/donor_login.php');
    exit();
}
...
<body>
  <div class="form-container">
    ...
    <form action="donate_handler.php" method="post">
      ...
      <input type="text" value="" id="blood_group" name="blood_group" required>
